      ...
      <div className="mx-auto flex max-w-[1560px] items-center justify-between gap-4 px-5 py-0 sm:px-8 lg:px-12 lg:py-[0px]">
        <a href="#top" className="flex items-center text-cream">
          ...
          <img
            ...
            className="block h-10 w-auto sm:h-12 lg:h-[82px]"
          />
        </a>
        ...
        <nav className="hidden items-center gap-8 lg:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center gap-2.5 whitespace-nowrap bg-whatsapp px-7 py-3.5 font-display text-xs font-semibold uppercase tracking-[0.24em] text-white transition-colors duration-150 ease-out hover:bg-whatsapp-hover"
          >
            <WhatsAppIcon />
            Haz tu pedido
          </a>
        ...
        <div className="flex items-center gap-3 lg:hidden">
          <a
            ...
            className="inline-flex items-center gap-2 whitespace-nowrap bg-whatsapp px-4 py-2.5 font-display text-[11px] font-semibold uppercase tracking-[0.2em] text-white transition-colors duration-150 ease-out hover:bg-whatsapp-hover"
          >
            <WhatsAppIcon />
